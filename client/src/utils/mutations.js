...
mutation JoinGroup($name: String!) {
 ...
 mutation Mutation($userId: ID!, $latitude: Int!, $longitude: Int!, $groupId: ID!) {
	addUserLocationToGroup(userId: $userId, latitude: $latitude, longitude: $longitude, groupId: $groupId) {
	  name
	}
  }
  `;
