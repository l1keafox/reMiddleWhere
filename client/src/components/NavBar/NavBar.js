      ...
      <nav className="relative flex flex-wrap items-center justify-between px-2 py-3 bg-slate-300 dark:bg-slate-700 mb-3">
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            <h1 className="font-marker text-4xl dark:text-slate-200 cursor-default select-none  ml-20 ">
              <span className="text-green-400">Middle</span>Where
            </h1>
            <button
          ...
          >
            <ul className="flex flex-col m-4 md:flex-row md:space-x-8 md:mt-0 md:text-mono md:font-mono">
              <li>
                <p
                  className="cursor-pointer block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:underline  md:hover:bg-transparent md:border-0 md:hover:text-blue-900 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                  onClick={navLink}
                  data-nav="profile"
                >
                  {" "}
              ...
              <li>
                <p
                  className="cursor-pointer block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:underline hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-900 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                  onClick={navLink}
                  data-nav="join"
                >
                  {" "}
